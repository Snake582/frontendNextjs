    ...
    <>
      ...
      <form className="shadow-md rounded-lg p-8 max-w-md w-full mt-3 border-x-8 border-indigo-500">
        <div className="mb-4">
          ...
          <input type="prenom" placeholder='Prenom' className="mt-1 px-4 py-2 w-full bg-blue-200 rounded-md shadow-2xl" required />
        </div>
        <div className="mb-4">
            <label className="text-sm font-medium text-gray-700">Nom</label>
          <input type="nom" placeholder='Nom' className="mt-1 px-4 py-2 w-full bg-blue-200 rounded-md shadow-2xl" required />
        </div>
        <div className="mb-4">
        ...
        <div className="mb-4">
          ...
          <input type="number" placeholder='Number' className="mt-1 px-4 py-2 w-full bg-blue-200 rounded-md shadow-2xl" required />
        </div>
        <div className="mb-4">
        ...
        <div className="mb-4">
          ...
          <input type="password" placeholder='Confirmer le mot de passe' className="mt-1 px-4 py-2 w-full bg-blue-200 rounded-md shadow-2xl" required />
        </div>
        <button type="submit" className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">Se connecter</button>
      </form>
      </div>
        <p className="text-sm text-gray-600 mt-3">
          Vous avez déjà un compte ? <Link href="/connexion" className="text-blue-600 hover:underline">Se connecter</Link>
        </p>
      </div>
    </>
  )
